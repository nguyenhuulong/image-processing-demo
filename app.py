...
st.set_page_config(page_title='Nguyen Huu Long - Portfolio', page_icon="☀", layout="wide")
...
## Contact Infomation
''')
txt2('Phone - Zalo', '0836131986')
txt2('Address', 'Nam Tu Liem, Ha Noi City, Vietnam')
txt2('Email', '[nguyenhuulong312@gmail.com](mailto:nguyenhuulong312@gmail.com)')
# txt2('LinkedIn', 'https://www.linkedin.com/in/lenguyengiabao/')
txt2('GitHub', 'https://github.com/nguyenhuulong/')
